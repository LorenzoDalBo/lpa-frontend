  ...
  return (
    <main className="bg-white py-4">
      <div className="flex justify-center">
        <div className="flex justify-center items-end rounded-2xl bg-bluesatc4 opacity-80 h-[60px] w-[600px] m-3 p-3">
        ...
        <Container className="bg-white">
          <Row>
            ...
            <Col className="text-black flex flex-col justify-center">
              <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-48 w-[600px] text-justify">
          ...
          <Row>
            <Col className="text-black flex flex-col justify-center">
              <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-48 w-[600px] text-justify mt-6">
                <h2 className="text-black text-3xl">
      ...
      <div className="mt-20">
        <Container className="bg-white">
          <Row>
            ...
            <Col className="text-black flex flex-col justify-center">
              <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-32 w-[600px] text-justify">
                <h2 className="text-black text-3xl">
          ...
          <Row>
            <Col className="text-black flex flex-col justify-center">
              <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-32 w-[600px] text-justify mt-6">
                <h2 className="text-black text-3xl">
                  <strong>Objetivo</strong>
                </h2>
                <p className="text-black">
                  Desenvolver e impulsionar projetos, de forma que sejam criados
      ...
      <div className="ml-[545px] mt-20">
        <Container className="bg-white">
          <Row>
            <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-36 w-[600px] text-justify">
              <h2 className="text-black text-3xl">
              ...
              <p className="mt-2 text-black">
                ...
                <a href="https://www.linkedin.com/in/eduardo-ribarski-a691b8250/">
                  Linkedn - https://www.linkedin.com/in/eduardo-ribarski-a691b8250/
                </a>
              </p>
            </div>
          </Row>
          <Row>
            <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-36 w-[600px] text-justify mt-6">
              <h2 className="text-black text-3xl">
            ...
            <div className="bg-bluesatc4 opacity-80 rounded-xl p-3 h-36 w-[600px] text-justify mt-6">
              ...
              <p className="mt-2 text-black">
                ...
                <a href="https://www.linkedin.com/in/lorenzo-dal-b%C3%B3-7710b4239/">
                  Linkedn - https://www.linkedin.com/in/lorenzo-dal-b%C3%B3-7710b4239/
                </a>
              </p>
            </div>
          </Row>
